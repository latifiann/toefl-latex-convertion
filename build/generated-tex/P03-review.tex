...
Bagian (D) salah karena setelah while gunakan bentuk V-ing; bagian studied harus studying. Bentuk yang benar adalah `studying`.\par
\endgroup
\par
...
Bagian (D) salah karena subjek species of animals bersifat jamak; verb harus live,. Bentuk yang benar adalah `live`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (A) salah karena kalimat sudah punya subjek Assessment instruments; they tidak perlu. , gunakan feature. Bentuk yang benar adalah `feature`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena setelah from, dua aktivitas harus parallel gerund; water-ski -> water-skiing. Bentuk yang benar adalah `water-skiing`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena adverb dibutuhkan untuk memodifikasi skilled; seharusnya highly skilled. Bentuk yang benar adalah `highly skilled`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena subjek plural nerves membutuhkan verb plural; interpret, bukan interprets. Bentuk yang benar adalah `interpret`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (C) salah karena setelah `possible` struktur infinitive harus paralel, yaitu `to have ... and to have ...`. Bentuk yang benar adalah `to have`.\par
...
Bagian (B) salah karena modal + base verb; election harus elect. Bentuk yang benar adalah `elect`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena knowledge uncountable; tidak pakai -s. Bentuk yang benar adalah `knowledge`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (C) salah karena parallel noun setelah certificates of; married harus marriage. Bentuk yang benar adalah `marriage`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena to + base verb; ratifying harus ratify. Bentuk yang benar adalah `ratify`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena butuh verb aktif sederhana; gunakan lack, bukan are lacking. Bentuk yang benar adalah `lack`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena subjek tunggal `mining` membutuhkan verb singular. Bentuk yang benar adalah `brings about`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena parallel dengan written (participle); gunakan reflecting, bukan reflected. Bentuk yang benar adalah `reflecting`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena narasi lampau; shoot harus shot. Bentuk yang benar adalah `shot a man`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena setelah are gunakan present participle; are growing up. Bentuk yang benar adalah `growing up`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena compound noun ini harus berbentuk `record albums`, bukan `records album`. Bentuk yang benar adalah `record albums`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (C) salah karena noun yang benar setelah the; present harus presence. Bentuk yang benar adalah `presence`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena subject singular theory -> verb explains. Bentuk yang benar adalah `explains`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena learn to + base verb; participation -> participate. Bentuk yang benar adalah `participate`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena will + base verb; fell -> fall. Bentuk yang benar adalah `fall`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (C) salah karena parallel adjective upper-lower; low harus lower. Bentuk yang benar adalah `lower`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (D) salah karena other + plural noun tanpa the; jadi other materials. Bentuk yang benar adalah `other`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (B) salah karena many + plural count noun; honor -> honors. Bentuk yang benar adalah `honors`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Bagian (C) salah karena comparative yang tepat smaller than; hapus as,. Bentuk yang benar adalah `smaller`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 1-28\par
Evidence quote: "His career started in 1828 ... later to the U.S. House of Representatives"\par
Jawaban (B) karena passage merangkum karier politik Johnson dari awal hingga konflik impeachment, sehingga fokus utamanya adalah perjalanan politiknya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena di sini, took office berarti mulai menjabat dalam posisi pemerintahan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 3-7\par
Evidence quote: "His career started in 1828 ... elected to the city council ... state senate ... state governor ... U.S. House of Representatives"\par
Jawaban (C) karena paragraf awal menyebut ia terpilih ke city council, mayor, state senate, governor, hingga U.S. House.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena alliance di sini berarti persatuan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena passage ini mengaitkan kejatuhannya langsung dengan karakter pribadinya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena ia sudah memiliki pengalaman politik yang luas sebelum menjadi presiden.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena detail ini menunjukkan bahwa warga Selatan cemas terhadap masa depan mereka.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena oposisi di Kongres merusak dan melemahkan masa kepresidenannya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena pardon paling dekat maknanya dengan exonerate dalam konteks ini.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (D) karena peristiwa Stanton menunjukkan bahwa Johnson kehilangan otoritas eksekutif.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena dismissed berarti diberhentikan atau dicopot dari jabatan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena upaya impeachment gagal dengan selisih yang sangat tipis.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 1-21\par
Evidence quote: "sex-trait stereotypes remain common among young adults today ... cross-nationally show a high degree of correspondence"\par
Jawaban (B) karena passage menekankan keluasan stereotip sex-trait dan keberlangsungannya lintas negara.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena ambitious paling dekat maknanya dengan enterprising.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena high-strung berarti nervous atau tense.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena passage ini menyatakan bahwa keyakinan kaum muda hampir tidak berubah.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena perpetuate berarti mempertahankan atau melanjutkan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "stereotyping has proved to be the psychological justification for social beliefs"\par
Jawaban (B) karena passage menyebut stereotyping sebagai justifikasi psikologis bagi keyakinan sosial tentang peran laki-laki dan perempuan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena paragraf kedua mendukung gagasan bahwa pembelajaran terjadi melalui paparan berbagai media.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena batasan penelitian disebut pada baris 13-15.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena passage ini mengatakan bahwa karakterisasi tersebut ditemukan di beberapa negara.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena correspondence paling dekat maknanya dengan agreement.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 5-6\par
Evidence quote: "In spite of the egalitarian movement, recent studies have demonstrated that sex-trait stereotypes remain common"\par
Jawaban (D) karena meski ada gerakan egalitarian, stereotip tetap umum; ini menyiratkan sikap sosial tidak mungkin berubah drastis.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 1-9\par
Evidence quote: "social beliefs concerning the appropriateness of various activities for men and women"\par
Jawaban (B) karena passage membahas stereotip dan peran sosial, yang merupakan kajian sosiologi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "promoting miraculous potions ... capitalize on real and imagined problems"\par
Jawaban (D) karena passage menyorot pemasaran klaim mukjizat yang menyesatkan di toko makanan sehat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 8-20\par
Evidence quote: "astounded, bewildered ... slight disregard for truth"\par
Jawaban (C) karena diksi dan contoh yang dipakai menyiratkan nada menyindir/ketus terhadap industri tersebut.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena touted paling dekat maknanya dengan talked about atau promoted.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 1-3\par
Evidence quote: "Garlic has long been touted ... squash has been thought by some to cure digestive disorders"\par
Jawaban (D) karena penulis memberi contoh garlic dan squash untuk menunjukkan miskonsepsi yang bertahan tentang makanan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (D) karena kesuksesan komersial dijelaskan saat passage menerangkan bagaimana toko mengeksploitasi kekhawatiran pelanggan.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (D) karena cajoled berarti coaxed atau persuaded.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena passage ini menyiratkan bahwa pemilik toko memaksimalkan keuntungan dengan mengeksploitasi gullibility konsumen.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena penulis menyiratkan bisnis ini bisa mendekati cheating.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena rencananya adalah mengalihkan industri dan ekonomi secara besar-besaran ke nuclear power.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena kata accepted menunjukkan bahwa publik bersikap receptive.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena nominal costs berarti biaya minimal.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena notion di sini berarti idea.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena this outlook merujuk pada ekspektasi peningkatan jumlah nuclear plants.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena contoh Shoreham menunjukkan bahwa pejabat meremehkan konsekuensi kecelakaan serius.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena passage ini menunjukkan bahwa konstruksi masih berlanjut, tetapi dalam skala yang jauh lebih kecil.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 1-25\par
Evidence quote: "Because geologists have long indicated ... Since 1975, this outlook and this estimation have changed drastically"\par
Jawaban (C) karena passage menghubungkan sebab dan akibat perubahan kebijakan nuklir dari awal hingga pembatalan proyek.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (D) karena masalah bahan bakar dan energi di masa depan masih belum terselesaikan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Collecting maps can be an enjoyable hobby ... a lucrative vocation ... interest for cartographers"\par
Jawaban (B) karena kalimat awal menegaskan peta dikoleksi oleh profesional sekaligus penggemar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena lucrative berarti profitable.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena hobi ini digambarkan kurang konvensional dibanding koleksi perangko.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena passage ini menyiratkan bahwa peta juga menarik bagi ardent devotees.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (C) karena economic means merujuk pada available funds.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena passage ini menyebut beberapa sumber, tetapi tidak menyebut fellow collectors.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (B) karena frasa ini berarti tampak membosankan dan tidak imajinatif.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (D) karena predisposed paling dekat maknanya dengan inclined.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Jawaban (A) karena paragraf berikutnya kemungkinan melanjutkan dengan organisasi spesifik untuk perolehan peta.\par
\endgroup
\par
\vspace{0.25\baselineskip}
\newpage
