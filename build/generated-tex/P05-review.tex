...
\begin{document}
\section*{TOEFL Practice 05 - Review}
...
Answer: B\par
Confidence: high\par
Grammar rule: Reduced passive clause as an appositive modifier.\par
Di antara dua koma, kalimat butuh modifier untuk `The Boston Public Library`, bukan klausa penuh baru. Bentuk ringkas pasif yang benar adalah `founded in 1854`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel verb structure with not only ... but also.\par
Setelah `not only`, bentuknya harus paralel dengan verb `test` sesudah `but also`. Karena itu `help to construct` paling tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: medium\par
Grammar rule: Past perfect for an action completed before another past event.\par
Makna yang paling wajar adalah tindakan mengarang selesai sebelum `he turned 14`, jadi perlu past perfect: `had composed`. Namun stem tampak rusak (`few ... a`), jadi perlu cek manual.\par
...
Answer: D\par
Confidence: high\par
Grammar rule: Preposition + gerund after method of.\par
Pola yang benar adalah `method of + V-ing`. Jadi `of measuring` melengkapi frasa `One of the quickest methods ... personality` dengan benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Restrictive relative clause for things.\par
Kata yang dijelaskan adalah `seeds`, sehingga diperlukan relative clause untuk benda. `that have` tepat untuk membentuk `seeds that have an unpleasant odor`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Simple past passive in the main clause.\par
Subjek `Patrick Henry` menerima tindakan mengajar, jadi bentuknya harus pasif. Karena konteks biografis masa lampau, `was taught` adalah pilihan yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Double comparative: the more ..., the more ....\par
Kalimat ini memakai pola perbandingan bertingkat: `the more ..., the more ...`. Karena itu bagian kedua harus `the more affluent they were`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Adverb clause with subject and verb.\par
Setelah `burns brightly`, dibutuhkan klausa waktu yang lengkap. `as it descends` benar karena memiliki conjunction, subject, dan verb.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel adjectives after linking verb.\par
Setelah `is`, unsur yang sejajar dengan `convenient` dan `affordable` harus adjective juga. Karena itu `comfortable` paling tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Parenthetical example phrase with such as.\par
Bagian di antara koma memberi contoh jenis alarm kebakaran. Frasa contoh yang benar adalah `such as the ubiquitous smoke detector`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Subject-verb agreement in simple present.\par
Subjek `the blood` bersifat tunggal, jadi verb-nya harus `fails`. Pola lengkap yang benar adalah `fails to supply enough oxygen`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel nouns after a preposition.\par
Setelah `as barriers to`, diperlukan dua noun yang paralel: `transportation` dan `communication`. Jadi `communication` adalah pelengkap yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Passive verb followed by by + gerund/noun.\par
Subjek `fabrics` menerima tindakan, jadi perlu bentuk pasif `are manufactured`. Cara pembuatannya dinyatakan dengan `by`, sehingga `are manufactured by` benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Normal adverb placement with a simple present verb.\par
Kalimat butuh predikat lengkap untuk subjek plural `Deer ticks`. Susunan yang alami dan benar adalah `never trouble vacationers`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Either ... or agreement with the nearest subject.\par
Pada `either ... or`, verb mengikuti subjek yang paling dekat. Karena yang dekat adalah `one of the other players` (tunggal), bentuk yang benar ialah `retrieves`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Double subject in main clause.\par
Correct form: was\par
Bagian (B) salah karena klausa utama sudah memiliki subjek `The Slater Mill` sehingga tambahan `it` membuat double subject. Bentuk yang benar adalah `was`.\par
\endgroup
\par
...
Answer: D\par
Confidence: high\par
Grammar rule: Preposition followed by gerund.\par
Correct form: talking\par
Bagian (D) salah karena setelah `by` untuk menyatakan cara, bentuk yang lebih tepat adalah gerund, bukan noun `talk`. Bentuk yang benar adalah `talking`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Missing article before nationality used as plural noun.\par
Correct form: The Japanese\par
Bagian (A) salah karena nama kebangsaan yang dipakai untuk menyebut suatu bangsa memerlukan artikel `the`. Bentuk yang benar adalah `The Japanese`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Incorrect relative connector after noun of time or age.\par
Correct form: age at which\par
Bagian (A) salah karena `which` tidak dapat langsung mengikuti `age` tanpa preposisi yang diperlukan. Bentuk yang benar adalah `age at which`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Verb form needed after quantifier subject.\par
Correct form: marry\par
Bagian (C) salah karena setelah subjek `few` dibutuhkan verba, bukan noun `marriage`. Bentuk yang benar adalah `marry`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Singular-plural agreement with determiner.\par
Correct form: other\par
Bagian (C) salah karena determiner `another` hanya dipakai untuk noun tunggal, sedangkan `sounds` berbentuk jamak. Bentuk yang benar adalah `other`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Comparative form of adjective.\par
Correct form: more compact\par
Bagian (C) salah karena bentuk komparatif adjective `compact` yang diharapkan dalam konstruksi ini adalah `more compact`. Bentuk yang benar adalah `more compact`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Adjective needed after verb for resultative complement.\par
Correct form: splits open\par
Bagian (B) salah karena setelah verba `splits` dibutuhkan adjective `open`, bukan adverb `openly`. Bentuk yang benar adalah `splits open`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Possessive form with plural noun.\par
Correct form: birds'\par
Bagian (B) salah karena yang dimaksud adalah sarang milik banyak burung, sehingga bentuk posesif plural harus dipakai. Bentuk yang benar adalah `birds'`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Missing auxiliary in passive construction.\par
Correct form: is prepared\par
Bagian (C) salah karena kalimat pasif memerlukan auxiliary `be` sebelum past participle. Bentuk yang benar adalah `is prepared`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective needed after linking verb.\par
Correct form: scarce\par
Bagian (D) salah karena setelah linking verb `was` dibutuhkan adjective, bukan adverb `scarcely`. Bentuk yang benar adalah `scarce`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: project\par
Bagian (D) salah karena subjek majemuk `the figures or designs` menuntut verba bentuk plural. Bentuk yang benar adalah `project`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Correlative expression requires full form.\par
Correct form: as well as\par
Bagian (C) salah karena ekspresi yang benar untuk menambahkan unsur sejajar adalah `as well as`, bukan hanya `as well`. Bentuk yang benar adalah `as well as`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Double verb after auxiliary.\par
Correct form: exist\par
Bagian (D) salah karena `are` dan `exist` tidak boleh dipakai bersama sebagai dua verba utama dalam struktur ini. Bentuk yang benar adalah `exist`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Past participle needed after being.\par
Correct form: being studied\par
Bagian (C) salah karena setelah `being` harus digunakan past participle untuk membentuk passive participial phrase. Bentuk yang benar adalah `being studied`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Incorrect noun form.\par
Correct form: spirit\par
Bagian (C) salah karena setelah artikel `a` dibutuhkan noun, sedangkan `spiritual` adalah adjective. Bentuk yang benar adalah `spirit`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Subordinate clause without main clause.\par
Correct form: Wine grapes\par
Bagian (A) salah karena `when` membentuk anak kalimat, tetapi kalimat ini tidak memiliki induk kalimat. Bentuk yang benar adalah menghilangkan `When` sehingga menjadi `Wine grapes`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Subject-verb agreement with compound subject.\par
Correct form: are\par
Bagian (A) salah karena subjek majemuk `Beef and dairy cattle` memerlukan verba plural. Bentuk yang benar adalah `are`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Incorrect noun form.\par
Correct form: imperfections\par
Bagian (D) salah karena noun yang tepat untuk cacat pada hasil cetak adalah `imperfections`, bukan `imperfectives`. Bentuk yang benar adalah `imperfections`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Incorrect auxiliary in comparative clause.\par
Correct form: are\par
Bagian (D) salah karena klausa perbandingan itu mengulang verba `are`, bukan verba `do`. Bentuk yang benar adalah `are`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: medium\par
Grammar rule: Countable noun used in generic plural sense.\par
Correct form: forms\par
Bagian (C) salah karena noun countable `form` dalam makna umum setelah `geometric` lebih tepat dipakai dalam bentuk jamak. Bentuk yang benar adalah `forms`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adverb form needed to modify participle.\par
Correct form: quickly counted\par
Bagian (D) salah karena modifier untuk participle `counted` harus berupa adverb, bukan adjective `quick`. Bentuk yang benar adalah `quickly counted`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Plural noun required with plural subject.\par
Correct form: change partners\par
Bagian (D) salah karena subjek `couples` berbentuk jamak, sehingga noun objek dalam pola umum ini juga harus jamak. Bentuk yang benar adalah `change partners`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Pronoun-antecedent agreement.\par
Correct form: them\par
Bagian (C) salah karena pronoun harus sesuai dengan antecedent `foods` yang berbentuk jamak. Bentuk yang benar adalah `them`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Past participle needed in reduced passive clause.\par
Correct form: played\par
Bagian (C) salah karena frasa itu merupakan bentuk pasif tereduksi yang memerlukan past participle, bukan present participle. Bentuk yang benar adalah `played`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 13-25\par
Evidence quote: "William Worral Mayo provided crucial assistance to his sons... The Mayo practice became known far and wide for its success in surgical procedures."\par
Jawaban (C) karena sebagian besar passage menyoroti peran William Worral Mayo, kedua putranya, dan generasi berikutnya dalam membangun serta mengembangkan Mayo Clinic. Judul lain terlalu sempit atau hanya mencakup sebagian isi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "staff physicians practice a special integrated approach to patient care"\par
Jawaban (A) karena integrated approach berarti pendekatan yang disatukan atau coordinated, paling dekat dengan unified.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 1-5\par
Evidence quote: "one of the largest medical facilities in the world... About 800 resident doctors assist the full-time physicians as a phase of their training"\par
Jawaban (C) karena paragraf pertama menyebut fasilitas ini sangat besar dan juga menjadi tempat pelatihan bagi resident doctors. Itu mendukung inferensi bahwa Mayo Clinic adalah specialized teaching hospital.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "when a cyclone struck Rochester, and he was placed in charge of an emergency hospital"\par
Jawaban (C) karena cyclone adalah bencana alam yang menghancurkan, sehingga sesuai dengan devastating natural disaster.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "His personal dedication and courage became legendary"\par
Jawaban (B) karena dedication dalam konteks sifat pribadi berarti devotion atau pengabdian.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "William Worral Mayo provided crucial assistance to his sons in launching their team practice in 1889... He and his brother, Charles Horace"\par
Jawaban (B) karena passage menyatakan ayah mereka membantu kedua putranya meluncurkan team practice, yaitu William James Mayo dan Charles Horace Mayo. Jadi merekalah physician pertama dalam praktik atau klinik itu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "founded the Mayo Graduate School of Medicine"\par
Jawaban (B) karena founded dalam konteks institusi berarti established, yaitu mendirikan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 16\par
Evidence quote: "donated \$1.5 million to establish the foundation for contributions"\par
Jawaban (C) karena contributions dalam konteks foundation dan donation berarti sumbangan atau gifts.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "served in the Army military corps as a brigadier general... Charles Horace was a professor of surgery and a health officer of Rochester subsequent to serving in the armed forces"\par
Jawaban (C) karena kedua Mayo brothers sama-sama memiliki military service, dan keduanya juga memegang peran publik atau profesional di luar praktik medis. Pilihan lain tidak berlaku untuk keduanya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "a health officer of Rochester subsequent to serving in the armed forces"\par
Jawaban (C) karena subsequent to dalam frasa itu berarti after, yaitu setelah bertugas di angkatan bersenjata.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The Mayo practice became known far and wide for its success in surgical procedures. In 1914, the practice moved into its own medical center"\par
Jawaban (D) karena alasan utama ekspansi dinyatakan ketika penulis menyebut praktik Mayo terkenal luas berkat keberhasilannya dalam surgical procedures, lalu langsung diikuti informasi perpindahan ke medical center sendiri dan pertumbuhan jumlah pasien.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 3-9, lines 12-18\par
Evidence quote: "From a business perspective, chain stores have numerous advantages over independent stores... They can also distribute their operating costs... By combining their marketing resources and distribution networks... controlling production decisions and the pricing policy."\par
Jawaban (B) karena fokus utama passage adalah alasan bisnis mengapa chain stores dan franchises menguntungkan: pembelian massal, distribusi terpusat, efisiensi biaya, dan kontrol pemasaran serta harga.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "department stores are franchises with numerous outlets. Chain stores are a group of retail stores"\par
Jawaban (C) karena dalam konteks ini outlets berarti cabang toko atau retail stores, jadi paling dekat dengan retailers.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Through the centralized system of distribution, chain stores can absorb the cost and price differential"\par
Jawaban (B) karena absorb di sini berarti menahan atau meredam selisih biaya dan harga, paling dekat dengan cushion.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "They can also distribute their operating costs for accounting, advertising, marketing, merchandising, and transportation."\par
Jawaban (B) karena passage menyatakan chain stores dapat membagi operating costs, sehingga dapat berhemat lewat pengendalian biaya operasional.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "research focuses on the probable market segments, it strongly considers consumer behavior and cognitive motives rather than the actual prices of goods"\par
Jawaban (B) karena marketing research menurut passage mencakup probable market segments dan consumer behavior atau cognitive motives, bukan harga aktual barang.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "accounts for about 23 percent of the unit price"\par
Jawaban (D) karena accounts for dalam konteks persentase berarti represents, yaitu membentuk atau mewakili 23 persen dari harga satuan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: medium\par
Evidence refs: lines 5-6, lines 12-15\par
Evidence quote: "purchase large quantities of goods... receive a discount... By combining their marketing resources and distribution networks... reduce unit prices."\par
Jawaban (C) karena passage justru menyebut pembelian dalam jumlah besar untuk mendapat diskon, bukan dividing purchase orders. Opsi lain masih terkait mekanisme efisiensi yang dibahas, meski tidak semuanya dinyatakan dengan istilah yang sama.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: medium\par
Evidence refs: lines 15-16\par
Evidence quote: "Franchises operate according to their contracts with the parent company and pay it a fraction of their net gains."\par
Jawaban (C) karena penyebutan contracts menunjukkan cara parent company mengendalikan franchise: operasi mereka diatur kontrak dan sebagian keuntungan dibayarkan ke perusahaan induk.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Franchises operate according to their contracts... They symbolize a brand name and identify their goods"\par
Jawaban (B) karena subject terdekat dan paling logis untuk they adalah Franchises.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "It is the central company that conducts marketing and communicates with manufacturers"\par
Jawaban (C) karena jika central company conducts marketing, implikasinya perusahaan induk kemungkinan besar menentukan bagaimana barang diiklankan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "They symbolize a brand name... Essentially, chain stores convert consumer brand name loyalty into profit"\par
Jawaban (D) karena passage secara eksplisit menyatakan chain stores mengubah consumer brand name loyalty menjadi profit, yaitu dengan memasarkan pengenalan atau loyalitas merek itu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "chain stores convert consumer brand name loyalty into profit"\par
Jawaban (A) karena convert di sini berarti turn, yaitu mengubah loyalitas merek menjadi keuntungan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: medium\par
Evidence refs: lines 1-3, lines 5-10\par
Evidence quote: "the organization conducting a census decides on and narrows the topics to be addressed ... Censuses examine such issues as population size and density ... Major censuses taken by the federal government are conducted every 10 years"\par
Jawaban (A) karena passage terutama membahas isi sensus, yaitu topik apa saja yang dicakup, dan kapan berbagai sensus dilakukan. Aspek analisis memang disebut, tetapi bukan fokus utama seluruh passage.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 1-2\par
Evidence quote: "decides on and narrows the topics to be addressed"\par
Jawaban (A) karena `narrows the topics` berarti membatasi atau mempersempit cakupan topik, paling dekat dengan `delimits`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Assimilating, compiling, and statistically analyzing the information is a work-intensive process that may sometimes take up to a year"\par
Jawaban (D) karena passage secara eksplisit menyebut proses sensus sangat menyita waktu dan bahkan bisa memakan waktu sampai satu tahun.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "population size and density, employment ... housing ... age ... industrial production ... local government"\par
Jawaban (D) karena passage menyebut data tentang ukuran atau populasi keluarga secara tidak langsung, produksi industri, dan isu pertanian, tetapi tidak pernah menyebut jaringan sosial.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "A detailed series of queries sample the data"\par
Jawaban (D) karena dalam konteks sensus, `queries` berarti pertanyaan-pertanyaan yang diajukan untuk mengumpulkan data.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "manufacturing censuses in the years that end in 3 and 8"\par
Jawaban (C) karena sensus industri atau manufaktur dilakukan pada tahun yang berakhir dengan 3 atau 8, sehingga 1998 cocok.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "To be consistent, information is gathered at approximately the same time"\par
Jawaban (B) karena `consistent` di sini berarti seragam atau dilakukan dengan cara atau waktu yang sama, yaitu `uniform`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: low\par
Evidence refs: lines 11-12\par
Evidence quote: "attempts to contact every individual residing or employed in a particular geographic area"\par
Jawaban (C) dipilih sebagai opsi yang paling mendekati, tetapi sebenarnya pilihan jawaban tidak memparafrasekan kalimat passage dengan baik. Evidence aslinya adalah semua orang yang tinggal atau bekerja di area geografis tertentu, sehingga item ini ambigu dan perlu dicek manual.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 11-13\par
Evidence quote: "the organization conducting the census attempts to contact every individual ... information is gathered at approximately the same time ... censuses question the individual"\par
Jawaban (B) karena pada lines 11-13 penulis menjelaskan mekanisme pengumpulan data: siapa yang dihubungi, kapan data dikumpulkan, dan bahwa pertanyaan mengacu pada tanggal tertentu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the information is analyzed to determine the extent of social and economic change and problems, as well as the resources available to deal with them"\par
Jawaban (B) karena data sensus dipakai untuk mengidentifikasi perubahan, masalah, dan sumber daya yang dibutuhkan, yaitu untuk menentukan kebutuhan yang muncul.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: medium\par
Evidence refs: lines 7-10, lines 15-16\par
Evidence quote: "Major censuses taken by the federal government ... During the years between censuses, the Census Bureau engages"\par
Jawaban (C) karena passage berulang kali mengaitkan sensus dengan `the federal government` dan `the Census Bureau`, sehingga implikasinya sensus umumnya dijalankan oleh pemerintah pusat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 15-16\par
Evidence quote: "update its statistics. The issues of Statistical Abstract of the United States summarize all the information that is collected"\par
Jawaban (D) karena `statistics` di konteks ini merujuk pada data atau informasi numerik yang terus diperbarui.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 1-3\par
Evidence quote: "The bee's entire body is covered with fine hairs to which grains of pollen adhere"\par
Jawaban (B) paling dekat karena passage menyatakan seluruh tubuh lebah tertutup fine hairs. Namun opsi tampak bermasalah secara OCR karena tertulis `fine layers`, jadi perlu cek manual.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "grains of pollen adhere as the bee moves from flower to flower, harvesting nectar and pollinating plants"\par
Jawaban (C) karena passage menyebut lebah memanen nectar, dan pollen menempel pada tubuhnya saat berpindah dari bunga ke bunga.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 2-3\par
Evidence quote: "The bee's entire body is covered with fine hairs to which grains of pollen adhere ... pollinating plants"\par
Jawaban (C) karena fungsi fine hairs pada tubuh adalah membawa pollen yang kemudian membantu proses penyerbukan. Opsi tampak terpotong pada kata `female`, jadi perlu cek manual.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The queens are larger by far than both workers and drones"\par
Jawaban (B) karena passage menyebut tiga kelas lebah: queens, workers, dan drones.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "thousands of lenses clustered closely to one another"\par
Jawaban (C) karena clustered closely berarti berkumpul rapat atau bunched together.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Their vision is especially receptive to hues of blue and yellow"\par
Jawaban (A) karena hues dalam konteks warna berarti shades atau nuansa warna.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 10-11\par
Evidence quote: "bees see red in the same way they see green but can distinguish geometrical patterns in the shapes of foliage and blossoms"\par
Jawaban (B) karena passage menyebut lebah melihat red sama seperti green, sehingga paling kecil kemungkinan mereka membedakan bunga merah dari foliage.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: medium\par
Evidence refs: lines 1-13\par
Evidence quote: "The term `fixed star` refers to stars whose positions do not seem to change... they can predict the direction of a star's movement in the near and distant future."\par
Jawaban (D) paling cocok karena seluruh passage membahas bintang tetap dalam kaitannya dengan gerak dan perubahan posisinya. Opsi ini tidak sempurna karena kata `emergence` tidak dibahas, tetapi tetap paling dekat dibanding opsi lain yang terlalu sempit atau tidak sesuai isi utama.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 6\par
Evidence quote: "stars appear stationary in their positions and relative distances from other bodies in a constellation"\par
Jawaban (B) karena penulis menyiratkan bahwa bintang tampak mempertahankan jarak relatifnya terhadap bintang atau benda langit lain dalam konstelasi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Barnard's star, which is considered to move the fastest among the fixed stars, requires 200 years to noticeably alter its position"\par
Jawaban (C) karena Barnard's star dipakai sebagai contoh acuan untuk menunjukkan seberapa lambat atau cepat pergerakan bintang tetap dapat diamati.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 6\par
Evidence quote: "stars appear stationary in their positions"\par
Jawaban (C) karena stationary dalam konteks ini berarti tampak tidak bergerak, yaitu immobile.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "unlike planets, stars are located at a great distance from the earth"\par
Jawaban (C) karena jika bintang, tidak seperti planet, berada sangat jauh dari bumi, maka dapat disimpulkan planet lebih dekat ke bumi daripada bintang.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "By using the spectrographs and photographs obtained over decades, scientists are able to detect changes in the proper motions of stars."\par
Jawaban (C) karena detect di sini paling dekat dengan trace, yaitu melacak atau mengenali perubahan gerak bintang dari waktu ke waktu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "By using the spectrographs and photographs obtained over decades... By computing the differences in the spectra length, color, and shade of color"\par
Jawaban (A) karena penulis menjelaskan dua langkah: memakai spectrographs dan photographs, lalu menghitung perbedaannya. Itu sesuai dengan penggunaan foto dan penalaran matematis.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "positions do not seem to change... the difference may not appear significant over a period of 50 or 70 years... stars appear stationary"\par
Jawaban (C) karena gagasan utama passage adalah bahwa gerakan fixed stars sangat sulit disadari secara langsung; mereka tampak tidak berubah atau stationary meskipun sebenarnya bergerak.\par
\endgroup
\par
\vspace{0.25\baselineskip}
\newpage
