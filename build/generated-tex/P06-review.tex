...
\begin{document}
\section*{TOEFL Practice 06 - Review}
...
Answer: C\par
Confidence: high\par
Grammar rule: Adjective phrase after linking verb.\par
Jawaban (C) karena setelah `is` dibutuhkan frasa adjektiva yang lengkap: `directly related to`. Pilihan lain tidak membentuk predikat yang gramatikal.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel structure with coordinated gerunds.\par
Jawaban (C) karena harus paralel dengan `launching`: `participated in launching ... and conducting ...`. Setelah preposisi `in`, bentuk -ing juga tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Complete clause with subject-verb-object.\par
Jawaban (A) karena kalimat membutuhkan predikat utama: `Various regions ... have retained the languages ...`. Pilihan lain hanya frasa atau susunan subjek-predikatnya salah.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Gerund as complement after means.\par
Jawaban (C) karena setelah `means` cocok digunakan gerund untuk menyatakan definisi: `Division means breaking up a number...`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Verb pattern with infinitive.\par
Jawaban (D) karena pola yang benar adalah `seek to solve`. Klausa relatifnya menjadi: `a problem that a client seeks to solve`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Comparative adjectives with than.\par
Jawaban (B) karena perbandingan dua kota memakai bentuk komparatif: `larger and more prosperous than New York`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Parallel verb phrases after infinitive of purpose.\par
Jawaban (A) karena dua tujuan dibuat paralel setelah `to`: `to feed cattle and sell to processing plants`. Pilihan lain merusak paralelisme.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Passive participle after linking verb plus infinitive of result.\par
Jawaban (D) karena setelah `remains` diperlukan pelengkap adjektival: `remains suspended`. Frasa `to form paint` menyatakan hasil atau fungsi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Singular count noun with determiner.\par
Jawaban (B) karena setelah `against` diperlukan frasa nomina tunggal yang benar: `another driver`. `other driver` tidak lengkap untuk noun tunggal.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Passive modal construction.\par
Jawaban (B) karena maknanya pasif: semua pihak `must be notified`. Struktur modal + be + past participle adalah bentuk yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Noun phrase as direct object.\par
Jawaban (C) karena verba `decreases` membutuhkan objek nomina yang alami: `essential brain functions`. Pilihan lain tidak membentuk frasa nomina yang tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Reduced passive participle phrase.\par
Jawaban (A) karena `purchased directly from farmers` adalah frasa participle pasif yang lengkap untuk menerangkan `goods`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel noun phrase.\par
Jawaban (C) karena harus paralel dengan noun `paintings`: `paintings and brilliant color`. Pilihan lain memakai adverb atau bentuk yang tidak sejajar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Appositive noun clause after the idea.\par
Jawaban (C) karena setelah `the idea` dibutuhkan klausa isi yang diawali `that`: `the idea that reason is superior to experience`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Parallel noun phrases after preposition.\par
Jawaban (A) karena setelah `for` dibutuhkan dua nomina paralel: `his stage activity and impressive dance technique`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Subject-verb agreement in relative clause.\par
Correct form: which grows in\par
Bagian (A) salah karena klausa relatif membutuhkan verba yang sesuai dengan subjek tunggal `Balm`. Bentuk yang benar adalah `which grows in`.\par
\endgroup
\par
...
Correct form: natural disasters\par
Bagian (D) salah karena daftar setelah `against` harus paralel dalam bentuk jamak: fire, robberies, floods, theft, dan natural disasters. Bentuk yang benar adalah `natural disasters`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Passive voice with agent.\par
Correct form: by poets\par
Bagian (B) salah karena verba pasif `were composed` harus diikuti agen dengan preposisi `by`, bukan `of`. Bentuk yang benar adalah `by poets`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Noun form after preposition.\par
Correct form: rate of growth\par
Bagian (D) salah karena setelah preposisi `of` dibutuhkan kata benda, bukan verb atau participle `grown`. Bentuk yang benar adalah `rate of growth`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Gerund after preposition.\par
Correct form: by splitting\par
Bagian (B) salah karena setelah preposisi `by` harus digunakan bentuk gerund. Bentuk yang benar adalah `by splitting`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Relative pronoun for things.\par
Correct form: that deal with\par
Bagian (C) salah karena `works` merujuk pada benda, sehingga tidak boleh memakai `whom`. Bentuk yang benar adalah `that deal with`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Passive form after be.\par
Correct form: is sung\par
Bagian (D) salah karena opera tidak `bernyanyi` sendiri; yang dibutuhkan adalah bentuk pasif. Bentuk yang benar adalah `is sung`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Infinitive base form.\par
Correct form: to control\par
Bagian (B) salah karena setelah `to` harus digunakan bentuk dasar verba, bukan bentuk berakhiran -s. Bentuk yang benar adalah `to control`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Gerund after preposition.\par
Correct form: by hunting\par
Bagian (D) salah karena setelah preposisi diperlukan bentuk yang menunjukkan cara, yaitu `by` + gerund. Bentuk yang benar adalah `by hunting`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Missing verb in compound predicate.\par
Correct form: is spoken\par
Bagian (B) salah karena setelah `and` dibutuhkan predikat lengkap yang sejajar dengan `is` pada klausa pertama. Bentuk yang benar adalah `is spoken`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Uncountable noun usage.\par
Correct form: the information\par
Bagian (A) salah karena `information` adalah kata benda tak dapat dihitung dan tidak dipakai dalam bentuk jamak. Bentuk yang benar adalah `the information`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: medium\par
Grammar rule: Verb pattern after modal.\par
Correct form: can carry\par
Bagian (B) salah karena setelah modal `can` seharusnya dipakai bentuk dasar aktif agar diikuti objek secara langsung, bukan bentuk pasif `be carried`. Bentuk yang benar adalah `can carry`.\par
...
Answer: D\par
Confidence: medium\par
Grammar rule: Collocation and logical complement.\par
Correct form: react to light\par
Bagian (D) salah karena frasa tersebut tidak lengkap secara makna; bahan kimia peka cahaya seharusnya bereaksi terhadap cahaya, bukan terhadap larutan khusus. Bentuk yang benar adalah `react to light`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Such + adjective + plural noun.\par
Correct form: such short\par
Bagian (A) salah karena pola yang benar adalah `such + adjective + plural noun` tanpa artikel `a` sebelum kata benda jamak. Bentuk yang benar adalah `such short`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Noun form after article.\par
Correct form: the hardness\par
Bagian (A) salah karena setelah artikel `the` dibutuhkan kata benda, bukan adjective `hard`. Bentuk yang benar adalah `the hardness`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Gerund after preposition.\par
Correct form: process of exchanging information\par
Bagian (A) salah karena setelah preposisi `of` harus dipakai gerund atau noun phrase, bukan bentuk dasar verba. Bentuk yang benar adalah `process of exchanging information`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Past participle after passive infinitive.\par
Correct form: melted\par
Bagian (C) salah karena setelah `need to be` harus digunakan past participle dalam bentuk pasif. Bentuk yang benar adalah `melted`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective vs adverb before noun.\par
Correct form: a steady stream\par
Bagian (D) salah karena sebelum kata benda `stream` dibutuhkan adjective, bukan adverb `steadily`. Bentuk yang benar adalah `a steady stream`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Passive perfect construction.\par
Correct form: has been paid\par
Bagian (D) salah karena `postage` menerima tindakan membayar, sehingga diperlukan bentuk pasif perfect. Bentuk yang benar adalah `has been paid`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Singular count noun needs article.\par
Correct form: a cast-iron pot\par
Bagian (D) salah karena kata benda tunggal dapat dihitung `pot` memerlukan artikel. Bentuk yang benar adalah `a cast-iron pot`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: diminishes\par
Bagian (C) salah karena subjek tunggal `force` membutuhkan verba tunggal dalam present tense. Bentuk yang benar adalah `diminishes`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Infinitive after purpose phrase.\par
Correct form: to break labor\par
Bagian (D) salah karena setelah `to` harus digunakan bentuk dasar verba, bukan gerund. Bentuk yang benar adalah `to break labor`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Fixed expression.\par
Correct form: as few as\par
Bagian (B) salah karena ungkapan yang benar adalah `as few as` untuk menunjukkan jumlah yang sangat kecil. Bentuk yang benar adalah `as few as`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Negative pronoun usage.\par
Correct form: no one\par
Bagian (B) salah karena subjek negatif yang benar untuk manusia adalah `no one`, bukan `not one` dalam konteks ini. Bentuk yang benar adalah `no one`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Reduced relative clause.\par
Correct form: persons living\par
Bagian (D) salah karena frasa tersebut merupakan reduced relative clause dan membutuhkan present participle, bukan past form `lived`. Bentuk yang benar adalah `persons living`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 7-9, lines 22-29\par
Evidence quote: "Materials which can be sculpted... are all used as sculpting media... In addition to carving a work, sculptures can be cast."\par
Jawaban (B) karena passage terutama membahas bahan yang dipakai untuk membuat patung dan dua teknik utamanya, yaitu carving dan casting. Opsi lain hanya membahas bagian kecil dari isi passage.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the ultimate shape of a sculpture reflects the artist's vision"\par
Jawaban (B) karena dalam konteks ini ultimate shape berarti bentuk akhir atau final dari patung.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the ultimate shape of a sculpture reflects the artist's vision of individuals or experiences represented by the work... people everywhere have discovered a need for sculpture as a record of events and feelings"\par
Jawaban (C) karena passage menegaskan bahwa bentuk akhir patung mencerminkan vision dari senimannya. Kalimat tentang record of events and feelings mendukung fungsi ekspresif itu, tetapi opsi (D) terlalu sempit dibanding gagasan utama penulis.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 5-6, lines 7-12\par
Evidence quote: "Throughout history, people everywhere have discovered a need for sculpture... Wood, stone, metal... are all used as sculpting media... represents a change from the older approach"\par
Jawaban (D) karena passage justru menyatakan bahwa sepanjang sejarah orang di mana-mana membutuhkan sculpture. Jadi pernyataan bahwa sculpture is no longer useful for people adalah satu-satunya yang tidak benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 14-18\par
Evidence quote: "the quality of the final product relies on the interplay between light and shade... the artist's work is brought to life by light, and its character can be altered by the control of the light source"\par
Jawaban (D) karena penulis menekankan bahwa sculpture ditampilkan dengan benar jika efek cahaya terhadap bentuk patung sesuai dengan yang dimaksud sculptor. Bukan sekadar kuat-lemahnya lampu, tetapi dampak light pada image patung itu sendiri.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "when viewing a painting, the audience can only see the point of view that the painter had intended"\par
Jawaban (B) karena audience di konteks melihat painting berarti orang yang melihat karya itu, yaitu viewers.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "A fundamental difference between a painting and a sculpture is that when viewing a painting, the audience can only see the point of view that the painter had intended. A free-standing sculpture can be seen from practically any angle."\par
Jawaban (B) karena penulis secara eksplisit menyebut painting hanya dapat dilihat dari sudut pandang yang dimaksud pelukis, sedangkan free-standing sculpture bisa dilihat dari hampir semua sudut.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 8-9, lines 26-28\par
Evidence quote: "stone, wood, ivory, or even ice... Bronze is the preferred metal... the space in a mold is filled with wax until it is melted"\par
Jawaban (D) karena ice, ivory, dan stone disebut langsung sebagai media sculpting. Wax hanya muncul sebagai bagian dari proses lost-wax casting, bukan sebagai sculpting medium dalam daftar media.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "a sculpture can be reproduced in a mold... Casting allows the artist to produce as many replicas as needed"\par
Jawaban (C) karena replicas dihubungkan langsung dengan reproduced in a mold, jadi maknanya adalah reproductions.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 8-9, lines 22-23\par
Evidence quote: "the sculptor carves or chips the substance... In addition to carving a work, sculptures can be cast"\par
Jawaban (A) karena passage menyebut dua cara dasar membuat sculpture: carving atau chipping bahan, dan casting dengan mold.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 1-23\par
Evidence quote: "The Beatles became the most popular group in rock music history... During the 1960s, their music matured... the much idolized group finally disbanded in 1970."\par
Jawaban (A) karena seluruh passage membahas sejarah perkembangan Beatles sekaligus ciri dan perubahan musik mereka, dari pembentukan grup sampai perpecahan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 4\par
Evidence quote: "Lennon and five others formed a group called the Quarrymen in 1956"\par
Jawaban (C) karena `Lennon and five others` berarti Lennon ditambah lima orang lain, jadi total enam anggota.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "While all of them sang, John Lennon and Paul McCartney wrote the majority of their songs."\par
Jawaban (A) karena passage menonjolkan Lennon dan McCartney sebagai penulis mayoritas lagu. Ini mengisyaratkan keduanya paling menonjol secara musikal dibanding anggota lain.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: medium\par
Evidence refs: lines 4-11\par
Evidence quote: "formed a group called the Quarrymen in 1956... The Beatles' U.S. tour propelled them to stardom... they took the top five spots on the singles charts"\par
Jawaban (C) karena dari pembentukan awal pada 1956 hingga menjadi bintang besar dan menguasai chart pada awal 1960-an, passage menyiratkan kenaikan popularitas mereka berlangsung cukup cepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 8-9\par
Evidence quote: "The Beatles' U.S. tour propelled them to stardom"\par
Jawaban (B) karena passage secara eksplisit menyatakan tur mereka di Amerika Serikat mendorong mereka menuju ketenaran besar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 12-16\par
Evidence quote: "their music matured and acquired a sense of melody. The lyrics of their songs became deeper and gained in both imagination and meaning."\par
Jawaban (A) karena passage jelas menyebut musik mereka menjadi lebih matang dan liriknya lebih dalam, imajinatif, dan bermakna dibanding masa awal yang masih sederhana.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: line 12\par
Evidence quote: "their music matured and acquired a sense of melody"\par
Jawaban (D) karena `acquired` dalam konteks ini berarti memperoleh atau mencapai kualitas tertentu, paling dekat dengan `attained`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 8-18\par
Evidence quote: "The Beatles' U.S. tour propelled them to stardom... During the 1960s... Their popularity continued to grow"\par
Jawaban (C) karena evidence menunjukkan puncak ketenaran terjadi setelah tur Amerika dan sepanjang pertumbuhan besar mereka pada awal hingga pertengahan 1960-an.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "McCartney's songs that created scenarios with off beat individuals"\par
Jawaban (B) karena `scenarios` di sini merujuk pada keadaan atau situasi yang dibangun dalam lagu-lagunya, bukan pemandangan atau tema cinta semata.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Lennon's sardonic music... and McCartney's songs that created scenarios with off beat individuals, contributed to the character of the music produced by the group."\par
Jawaban (C) karena passage menyatakan gaya Lennon dan McCartney memberi `character` pada musik Beatles, yaitu membuat repertoar grup itu lebih khas dan berbeda.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 19-23\par
Evidence quote: "the musicians began to drift apart... the much idolized group finally disbanded in 1970."\par
Jawaban (A) karena `disbanded` dalam konteks grup musik yang anggotanya mulai `drift apart` berarti bubar atau berpisah, paling dekat dengan `separated`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 4-24\par
Evidence quote: "Nomadic migrations required Indians to construct shelters... Eastern Woodland Indian tribes lived in bark-covered wigwams... The Iroquois... built longhouses... Pueblo Indians... constructed elaborate housing with several stories and many rooms."\par
Jawaban (C) karena hampir seluruh passage membahas jenis-jenis tempat tinggal atau shelter yang dibangun oleh berbagai kelompok Indian, bukan budaya mereka secara umum.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "their cultures and languages were only marginally similar"\par
Jawaban (B) karena marginally similar dalam konteks ini berarti hanya sedikit atau minimally mirip.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 4\par
Evidence quote: "and by and large, they had different ways of life"\par
Jawaban (A) karena by and large berarti secara umum atau mostly.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 4-6\par
Evidence quote: "Nomadic migrations required Indians to construct shelters that did not need to be transported, but could be easily erected from the materials found in their new location."\par
Jawaban (D) karena jika mereka bermigrasi dan shelter tidak dibawa, implikasinya mereka perlu membangun shelter lagi di lokasi baru.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Eastern Woodland Indian tribes lived in bark-covered wigwams that were shaped like cones or domes."\par
Jawaban (B) karena cone dan dome sama-sama menunjukkan bentuk membulat atau round, bukan rectangular.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "leaving an opening to serve as a door and to allow smoke to escape"\par
Jawaban (C) karena adanya lubang untuk membiarkan asap keluar menyiratkan bahwa mereka menyalakan api di dalam hut.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 12\par
Evidence quote: "five to a dozen families lived under one roof"\par
Jawaban (D) karena under one roof berarti tinggal bersama dalam satu bangunan, yaitu together.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Nomadic migrations required Indians to construct shelters... Pueblo Indians... constructed elaborate housing with several stories and many rooms."\par
Jawaban (A) karena Woodland Indians dikaitkan dengan shelter nomadik yang mudah didirikan ulang, sedangkan Pueblo Indians tinggal di struktur besar bertingkat yang bersifat lebih permanen.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 16-18, lines 22-24\par
Evidence quote: "The ground story of a Pueblo dwelling had no doors or windows in order to prevent enemies from entering... a solid roof to preclude the water from leaking inside."\par
Jawaban (B) karena passage menyebut dua fungsi perlindungan yang jelas: mencegah musuh masuk dan mencegah air hujan bocor ke dalam.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: line 24\par
Evidence quote: "created a solid roof to preclude the water from leaking inside"\par
Jawaban (B) karena preclude dalam konteks ini berarti mencegah atau stop air agar tidak masuk.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 8-18, lines 21-26\par
Evidence quote: "The analysis of compression and tension in the earth's crust... Although each continent has its special features... Mountain belts are elongated narrow zones..."\par
Jawaban (C) karena mayoritas passage membahas struktur benua, lapisan kerak, komponen pembentuk benua, dan pembentukan pegunungan; definisi continent hanya pembuka.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the term `continent` refers to the surface of continuous landmasses..."\par
Jawaban (A) karena definisi geografis pada passage adalah continuous landmasses, yaitu massa daratan yang berkesinambungan atau tanpa terputus.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Although all continents are bounded by water bodies or high mountain ranges"\par
Jawaban (C) karena bounded dalam konteks ini berarti dibatasi atau delimited oleh perairan atau pegunungan tinggi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "disagreement among geologists surrounds the issue of exactly how many layers underlie each landmass because of their distinctive mineral and chemical composition"\par
Jawaban (D) karena passage menyatakan perbedaan pendapat muncul akibat komposisi mineral dan kimia yang khas, jadi inti masalahnya adalah chemical makeup yang berbeda.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "measurements of the specifics within crust formations by means of monitoring earthquakes"\par
Jawaban (C) karena specifics di sini merujuk pada rincian yang tepat dalam formasi kerak, bukan spekulasi atau gerakan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "a chemical split occurred to form the atmosphere, sea water, and the crust before it solidified"\par
Jawaban (B) karena yang paling logis dapat solidified adalah the crust; atmosphere dan sea water tidak cocok dengan verba itu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The continental crust is believed to have been formed... geologists can speculate that a chemical split occurred"\par
Jawaban (A) karena penulis memakai believed dan speculate, yang menunjukkan proses terbentuknya kerak benua belum diketahui secara pasti.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The basic differences among continents lie in the proportion and the composition of these features relative to the continent size"\par
Jawaban (B) karena perbedaan struktur benua dijelaskan sebagai perbandingan proporsi komponen utama dan komposisinya terhadap ukuran benua.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: medium\par
Evidence refs: lines 23-25\par
Evidence quote: "When continental margins collide... This process also accounts for the occurrence of mountain belts"\par
Jawaban (A) karena This process paling dekat merujuk pada tabrakan margin benua, yaitu proses yang memicu pembentukan pegunungan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "produces evidence for the ongoing continental plate evolution"\par
Jawaban (D) karena ongoing continental plate evolution menyiratkan proses perkembangan atau pembentukan benua masih terus berlangsung.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence refs: lines 25-26\par
Evidence quote: "produces evidence for the ongoing continental plate evolution"\par
Jawaban (B) karena evidence dalam konteks ini berarti bukti yang mengonfirmasi bahwa evolusi lempeng benua masih berlangsung.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 1-4, lines 16-24\par
Evidence quote: "Chicago ranks as the leading industrial and urban center in North America... This poetic phrase, however, does not do justice to the city's outstanding array of cultural institutions... The Chicago metropolitan area has undergone dramatic changes since the 1940s... Today, most of the city's ethnic enclaves have faded away, but their rich heritage remains."\par
Jawaban (A) karena isi passage paling luas membahas perkembangan Chicago sebagai pusat industrial dan urban, lalu perubahan sosial-demografisnya dari masa imigrasi sampai periode setelah 1940-an. Pilihan lain hanya menangkap bagian kecil seperti wisata atau bangunan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Carl Sandburg called it the `City of the Big Shoulders`... This poetic phrase, however, does not do justice to the city's outstanding array of cultural institutions, such as the symphony orchestra and the museums of art and history."\par
Jawaban (C) karena penulis secara eksplisit berkata frasa Sandburg `does not do justice` pada banyak sisi menarik Chicago, khususnya institusi budayanya. Artinya frasa itu melewatkan banyak daya tarik kota tersebut.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The downtown business district on the shore of Lake Michigan is the hub of fashionable and elegant boutiques, quaint restaurants, and high-rise office buildings."\par
Jawaban (B) karena dalam konteks ini hub berarti pusat tempat berbagai aktivitas atau tempat penting terkonsentrasi. Jadi makna terdekatnya adalah center.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 8-9\par
Evidence quote: "The Old Water Tower, dwarfed by the John Hancock Center, is a must-see landmark frequented by thousands of tourists each year."\par
Jawaban (A) karena kata dwarfed by menyiratkan Old Water Tower tampak jauh lebih kecil dibanding John Hancock Center. Implikasi paling langsung adalah Old Water Tower lebih pendek.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Throughout its history, Europeans streamed into the city in search of jobs in steel mills and factories. The large influx of population created tensions in various neighborhoods."\par
Jawaban (C) karena passage menyebut Europeans `streamed into the city` dan ada `large influx of population`, yang jelas menunjukkan mereka datang dalam jumlah besar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 16-17\par
Evidence quote: "The Chicago metropolitan area has undergone dramatic changes since the 1940s when the suburban population almost doubled, and the number of city residents fell."\par
Jawaban (A) karena kenaikan tajam populasi suburb dan turunnya jumlah penduduk kota menunjukkan banyak orang pindah keluar kota ke daerah pinggiran atau kota tetangga.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The residents take pride in impressive churches and blocks of homes constructed in the early 20th century by industrious European immigrants who built the city."\par
Jawaban (B) karena industrious dalam konteks deskripsi para imigran yang membangun kota berarti rajin atau pekerja keras. Makna terdekatnya adalah hard-working.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "More than 85\% of Chicagoans were born in the United States... Italian is no longer spoken in Little Italy, and Irish pubs have fewer Irish customers than those of mixed, typically American origins."\par
Jawaban (D) karena evidence menunjukkan mayoritas penduduk lahir di Amerika Serikat dan bahasa etnis seperti Italian sudah tidak lagi dipakai di area yang dulu khas. Implikasi paling kuatnya adalah kebanyakan warga sekarang terutama berbahasa Inggris.\par
\endgroup
\par
\vspace{0.25\baselineskip}
\newpage
