...
\begin{document}
\section*{TOEFL Practice 01 - Review}
...
Answer: C\par
Confidence: medium\par
Jawaban dan opsi nomor 33 diambil dari sumber belajar yang diberikan pengguna dan belum diverifikasi terhadap audio/transkrip resmi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
\noindent\textbf{34.}
...
Answer: B\par
Confidence: high\par
Grammar rule: Reduced relative clause; past participle modifier.\par
Gunakan past participle untuk frasa reduced relative clause: land bought from the Seneca Indians.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Relative clause for modifier.\par
Perlu klausa relatif yang menjelaskan proporsi: which alter soil porosity.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Adverbs modifying verb.\par
Setelah verb depict, gunakan adverb: accurately and objectively.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Fixed comparison pattern and article use.\par
Ungkapan baku: a part to the whole or a part to another part.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Plural comparison pronoun.\par
Bandingkan bones (plural) dengan those of young people.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Simple past verb without extra subject.\par
Subjek sudah ada; gunakan simple past: settlers established Belfast.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Subordinating conjunction + full clause.\par
Perlu klausa lengkap: because they affect large segments of the population.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Quantifier for small number.\par
Makna yang tepat: only a few feathered creatures.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Past perfect with object.\par
Sebelum 1930, gunakan past perfect: had achieved success as a lawyer.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Frasa baku: from one place to another.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Passive participles after linking verb.\par
Setelah are ordinarily gunakan past participles: owned and operated.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Adverb placement and singular verb.\par
Subjek singular butuh increases; adverb: apparently increases.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Subject-verb agreement; active voice.\par
Each bowler (singular) -> rolls the ball twice.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Nonrestrictive relative clause.\par
Gunakan all of whom untuk klausa tambahan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Preposition because of + noun phrase.\par
Bentuk tepat: because of its motion and mass.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Adjective vs noun object.\par
Correct form: moisture\par
Bagian (C) salah karena setelah verb carries perlu noun; moist harus menjadi moisture. Bentuk yang benar adalah `moisture`.\par
\endgroup
\par
...
Answer: D\par
Confidence: high\par
Grammar rule: Passive verb form.\par
Correct form: admired\par
Bagian (D) salah karena butuh verb pasif: was admired, bukan noun admiration. Bentuk yang benar adalah `admired`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: select\par
Bagian (B) salah karena setelah must gunakan base verb: must select. Bentuk yang benar adalah `select`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Noun phrase formation.\par
Correct form: office buildings\par
Bagian (D) salah karena frasa noun yang benar: office buildings. Bentuk yang benar adalah `office buildings`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective vs noun form.\par
Correct form: territory\par
Bagian (D) salah karena butuh noun: Sioux territory, bukan territorial. Bentuk yang benar adalah `territory`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Article usage in comparison.\par
Correct form: a number\par
Bagian (D) salah karena butuh artikel: the same as a number. Bentuk yang benar adalah `a number`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: aid\par
Bagian (A) salah karena muscles plural, verb harus aid. Bentuk yang benar adalah `aid`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Parallel noun number.\par
Correct form: scholar\par
Bagian (D) salah karena sesuai artikel a, gunakan singular scholar. Bentuk yang benar adalah `scholar`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Word form.\par
Correct form: handheld\par
Bagian (D) salah karena kata yang benar: handheld calculators. Bentuk yang benar adalah `handheld`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Tense for general statement.\par
Correct form: is\par
Bagian (C) salah karena pernyataan umum gunakan present: it is. Bentuk yang benar adalah `is`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Passive participle.\par
Correct form: defined\par
Bagian (A) salah karena passive: is defined as. Bentuk yang benar adalah `defined`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Conjunction vs preposition.\par
Correct form: because\par
Bagian (C) salah karena gunakan because + clause, bukan because of + clause. Bentuk yang benar adalah `because`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective degree.\par
Correct form: great\par
Bagian (D) salah karena untuk jumlah, gunakan great, bukan comparative greater. Bentuk yang benar adalah `great`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Past participle modifier.\par
Correct form: designed\par
Bagian (D) salah karena gunakan past participle untuk modifier: outlets designed. Bentuk yang benar adalah `designed`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Reduced passive clause.\par
Correct form: housed\par
Bagian (A) salah karena frasa reduced passive clause membutuhkan past participle untuk menerangkan `troops`. Bentuk yang benar adalah `housed`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Adjective vs noun.\par
Correct form: successful\par
Bagian (B) salah karena butuh adjective: the first successful starter. Bentuk yang benar adalah `successful`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: medium\par
Grammar rule: Infinitive phrase of purpose.\par
Correct form: for their audiences to enjoy\par
Bagian (D) salah karena frasa yang lebih tepat adalah 'for their audiences to enjoy'. Bentuk infinitive phrase tersebut menyatakan tujuan, yaitu bahwa pertunjukan disajikan agar dapat dinikmati oleh penonton. Bentuk yang benar adalah `for their audiences to enjoy`.\par
...
Answer: C\par
Confidence: medium\par
Grammar rule: Noun number in object.\par
Correct form: humans\par
Bagian (C) salah karena objek study harus plural: study of humans. Bentuk yang benar adalah `humans`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: wide\par
Bagian (D) salah karena gunakan adjective wide sebelum noun array; widely adalah adverb. Bentuk yang benar adalah `wide`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Comparative adverb.\par
Correct form: more slowly\par
Bagian (B) salah karena setelah rotates gunakan adverb: more slowly. Bentuk yang benar adalah `more slowly`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Redundant subject.\par
Correct form: studied\par
Bagian (A) salah karena hapus pronoun: Van Cliburn studied piano. Bentuk yang benar adalah `studied`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Inversion after negative adverbial.\par
Correct form: do comics\par
Bagian (A) salah karena not only + auxiliary inversion: Not only do comics show. Bentuk yang benar adalah `do comics`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Passive verb form.\par
Correct form: it is arranged\par
Bagian (D) salah karena kalimat pasif: how it is arranged. Bentuk yang benar adalah `it is arranged`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: medium\par
Grammar rule: Active/modal construction for permission.\par
Correct form: are allowed to use\par
Bagian (C) salah karena frasa 'are used' tidak tepat karena subjek 'readers' adalah pihak yang melakukan aksi menggunakan library. Bentuk yang lebih tepat adalah konstruksi aktif/modal seperti 'these readers are allowed to use the library' atau 'these readers may use the library'. Bentuk yang benar adalah `are allowed to use`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Count vs noncount noun.\par
Correct form: information\par
Bagian (B) salah karena `information` adalah noun uncountable dan tidak memakai bentuk jamak. Bentuk yang benar adalah `information`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: medium\par
Evidence refs: lines 1-3, lines 19-26\par
Evidence quote: "Charles Lindbergh was born in Detroit, Michigan, in 1902... Embarking on the greatest adventure of his time, Lindbergh left Roosevelt Field..."\par
Jawaban (B) karena isi passage berbentuk ringkasan hidup dan pencapaian Lindbergh; judul terbaik menekankan biografinya.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the young man was seeking more challenging endeavors, and two years later he became a stunt pilot"\par
Jawaban (A) karena ia meninggalkan studi karena memilih jadi stunt pilot (exhibition pilot).\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "public assemblies"\par
Jawaban (C) karena assemblies di konteks ini berarti kumpulan orang: gatherings.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "became a stunt pilot who performed feats... This unusual and dangerous undertaking"\par
Jawaban (D) karena undertaking merujuk pada aksi stunt pilot yang melakukan feats.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "paid off handsomely"\par
Jawaban (C) karena handsomely di sini bermakna with good results: well.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "completed his program... at the top of his class"\par
Jawaban (C) karena top of his class menunjukkan ia yang terbaik di antara cadet lain.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "employment as a mail pilot to run the routes between St. Louis and Chicago"\par
Jawaban (A) karena menjalankan rute antarkota berarti penerbangan reguler antar kota.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "irreversibly change his life"\par
Jawaban (A) karena irreversibly berarti forever.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: medium\par
Evidence refs: line 1, lines 19-20\par
Evidence quote: "born in Detroit, Michigan, in 1902... on May 20, 1927"\par
Jawaban (D) karena dari 1902 ke 1927 = 25 tahun, jadi umur sekitar 25.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "he would be unknown when he arrived... overwhelmed by tremendous welcoming crowds"\par
Jawaban (B) karena ia mengira akan tidak dikenal; jadi ia tidak mengantisipasi jadi selebritas.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 6-7\par
Evidence quote: "This unusual and dangerous undertaking"\par
Jawaban (C) karena stunt pilot dianggap tidak biasa, jadi exhibition tours bukan hal umum.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "overwhelmed by tremendous welcoming crowds... decorated in France, Great Britain, and Belgium"\par
Jawaban (C) karena paragraf berikutnya kemungkinan membahas dampak celebrity instan pada Lindbergh.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Lithography is a planographic process... the artist draws... the surface is covered with thick, oily ink and pressed onto paper"\par
Jawaban (B) karena passage menjelaskan langkah-langkah teknik lithography, jadi fokusnya proses pembuatan impresi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "water does not combine with grease-based substances"\par
Jawaban (B) karena prinsip utama lithography: minyak/grease tidak bercampur dengan air.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "contour"\par
Jawaban (C) karena contour berarti outline.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 7\par
Evidence quote: "leveled, grainy plate"\par
Jawaban (D) karena leveled berarti diratakan/flattened.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The gum arabic envelops the greased surfaces"\par
Jawaban (C) karena envelops berarti coats.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 13-14\par
Evidence quote: "pressed onto paper. The sheet picks up the ink from the design"\par
Jawaban (A) karena kertas mengambil ink dari desain pada plate, jadi absorbs/picks up.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "contour does not need to be engraved... or raised above the surface"\par
Jawaban (B) karena keunggulan dibanding gravure/letterpress disebut di baris 3-5.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: medium\par
Evidence refs: lines 16-19\par
Evidence quote: "offset lithography... rotary presses automatically moisten, ink, and print"\par
Jawaban (C) karena setelah offset lithography dibahas, paragraf berikutnya kemungkinan perkembangan teknologi offset.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: line 19\par
Evidence quote: "print hundreds of impressions per hour"\par
Jawaban (B) karena impressions di sini berarti hasil cetak/reproductions.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the simplest are unicellular organisms"\par
Jawaban (A) karena unicellular berarti satu sel.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 4\par
Evidence quote: "serves as the outer tissue"\par
Jawaban (C) karena outer tissue paling dekat artinya shell.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the cell membrane... has to penetrate it to reach the cytoplasm"\par
Jawaban (C) karena it merujuk ke membrane yang harus ditembus untuk mencapai cytoplasm.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "each with its own nucleus, genetic code, and RNA"\par
Jawaban (C) karena passage menyebut bahwa setiap sel memiliki nucleus, genetic code, dan RNA, sehingga opsi ini paling cocok. Namun, klaimnya tetap perlu dibatasi pada konteks passage.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "loosely assembled groups"\par
Jawaban (C) karena loosely berarti freely/longgar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 8\par
Evidence quote: "symbiotic relationship"\par
Jawaban (A) karena symbiotic berarti mutually dependent.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 11-12\par
Evidence quote: "overall size... contingent on the total number of cells"\par
Jawaban (D) karena ukuran tubuh tergantung jumlah sel, jadi organisme besar punya lebih banyak sel.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: line 10\par
Evidence quote: "each with its own nucleus"\par
Jawaban (C) karena each merujuk ke cells yang specialized.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 12-13\par
Evidence quote: "The simplest multicellular animals are hydras, sponges, and jellyfish"\par
Jawaban (B) karena sponges dan jellyfish disebut sebagai multicellular paling sederhana.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "mentions cell membrane, cytoplasm, colonial organisms, specialized cells"\par
Jawaban (A) karena tidak ada pembahasan mekanisme reproduksi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 1-16\par
Evidence quote: "protozoans, cells, membranes, multicellular organisms"\par
Jawaban (C) karena topiknya biologi umum.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: medium\par
Evidence refs: lines 1-10\par
Evidence quote: "the Alexandrian... founded by Alexander the Great... expanded the library"\par
Jawaban (B) karena pembahasan utama adalah asal-usul dan sejarah perpustakaan Alexandria.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "it became feasible to establish libraries"\par
Jawaban (A) karena feasible berarti practicable.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "According to second-hand reports"\par
Jawaban (B) karena laporan tersebut bersifat second-hand, informasi tentang library tidak berasal dari bukti langsung sehingga sulit diverifikasi sepenuhnya.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: medium\par
Evidence refs: lines 6-9\par
Evidence quote: "borrowed scrolls... ordered them duplicated... employed more than 100 scribes"\par
Jawaban (B) karena langkah-langkah pengadaan menunjukkan mereka mengalokasikan sumber daya.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "purchased entire lesser libraries... owned a copy of every contemporary scroll"\par
Jawaban (D) karena tujuan utama: mengumpulkan semua scroll dan memperkaya koleksi.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "not a trace of the Alexandrian library remains today"\par
Jawaban (C) karena implikasinya, koleksi tidak dapat diperiksa lagi.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 13-14\par
Evidence quote: "a bibliography of Greek literature was compiled and cross-referenced"\par
Jawaban (C) karena pernyataan ini eksplisit di passage, jadi pilihan C paling tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "a succession of leading scholars"\par
Jawaban (A) karena succession berarti series.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "accessible to only a minority of the population"\par
Jawaban (B) karena akses terbatas menunjukkan manfaat terutama untuk kelas atas/elite.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 20-21\par
Evidence quote: "not a trace of the Alexandrian library remains"\par
Jawaban (B) karena not a trace berarti absolutely nothing tersisa.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 1-14\par
Evidence quote: "oldest rocks... earth's age... radioactive dating... rejected this figure"\par
Jawaban (D) karena seluruh passage fokus pada penentuan usia bumi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "oldest rocks found on earth... radioactive dating"\par
Jawaban (C) karena radioactive dating dipakai untuk menentukan umur bumi.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "eventual burning out of stars"\par
Jawaban (A) karena eventual paling dekat dengan ultimate.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 2-6\par
Evidence quote: "Similar ages... the sun is about 5 billion years old... formed at almost the same time"\par
Jawaban (C) karena moon rocks seumuran dan bumi-matahari terbentuk hampir bersamaan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 6-7\par
Evidence quote: "earth and the sun were formed at almost the same time from a cloud of dust and gas"\par
Jawaban (A) karena implikasi: asal-usul bumi dan matahari serupa.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "present rate of expansion of the galaxies"\par
Jawaban (C) karena passage menyebut `the present rate of expansion of the galaxies`, sehingga opsi ini yang paling mendekati. Namun, redaksi `formation of galaxies` memang kurang presisi dibanding `expansion of galaxies`.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: line 9\par
Evidence quote: "can be considered plausible"\par
Jawaban (A) karena plausible berarti reasonable.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 13-14\par
Evidence quote: "radioactive dating... has rejected this figure... as unreliable"\par
Jawaban (B) karena penulis menilai radioactive dating lebih akurat dibanding metode lama.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
