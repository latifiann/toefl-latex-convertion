...
Setelah verb carries perlu noun; moist harus menjadi moisture.\par
\endgroup
\par
...
Butuh verb pasif: was admired, bukan noun admiration.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Setelah must gunakan base verb: must select.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Frasa noun yang benar: office buildings.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Butuh noun: Sioux territory, bukan territorial.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Butuh artikel: the same as a number.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Muscles plural, verb harus aid.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Sesuai artikel a, gunakan singular scholar.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Kata yang benar: handheld calculators.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: is\par
Pernyataan umum gunakan present: it is.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Gunakan because + clause, bukan because of + clause.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Untuk jumlah, gunakan great, bukan comparative greater.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Gunakan past participle untuk modifier: outlets designed.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Troops housed in Fort Bliss...\par
\endgroup
\par
\vspace{\questionblockgap}
...
Butuh adjective: the first successful starter.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Frasa yang lebih tepat adalah 'for their audiences to enjoy'. Bentuk infinitive phrase tersebut menyatakan tujuan, yaitu bahwa pertunjukan disajikan agar dapat dinikmati oleh penonton.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Objek study harus plural: study of humans.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Gunakan adjective wide sebelum noun array; widely adalah adverb.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Setelah rotates gunakan adverb: more slowly.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Hapus pronoun: Van Cliburn studied piano.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Not only + auxiliary inversion: Not only do comics show...\par
\endgroup
\par
\vspace{\questionblockgap}
...
Kalimat pasif: how it is arranged.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Frasa 'are used' tidak tepat karena subjek 'readers' adalah pihak yang melakukan aksi menggunakan library. Bentuk yang lebih tepat adalah konstruksi aktif/modal seperti 'these readers are allowed to use the library' atau 'these readers may use the library'.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Information adalah uncountable: information.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Isi passage berbentuk ringkasan hidup dan pencapaian Lindbergh; judul terbaik menekankan biografinya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Ia meninggalkan studi karena memilih jadi stunt pilot (exhibition pilot).\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Assemblies di konteks ini berarti kumpulan orang: gatherings.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Undertaking merujuk pada aksi stunt pilot yang melakukan feats.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Handsomely di sini bermakna with good results: well.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Top of his class menunjukkan ia yang terbaik di antara cadet lain.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Menjalankan rute antarkota berarti penerbangan reguler antar kota.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Irreversibly berarti forever.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Dari 1902 ke 1927 = 25 tahun, jadi umur sekitar 25.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Ia mengira akan tidak dikenal; jadi ia tidak mengantisipasi jadi selebritas.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Stunt pilot dianggap tidak biasa, jadi exhibition tours bukan hal umum.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Paragraf berikutnya kemungkinan membahas dampak celebrity instan pada Lindbergh.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Passage menjelaskan langkah-langkah teknik lithography, jadi fokusnya proses pembuatan impresi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Prinsip utama lithography: minyak/grease tidak bercampur dengan air.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Leveled berarti diratakan/flattened.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Kertas mengambil ink dari desain pada plate, jadi absorbs/picks up.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Keunggulan dibanding gravure/letterpress disebut di baris 3-5.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Setelah offset lithography dibahas, paragraf berikutnya kemungkinan perkembangan teknologi offset.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Impressions di sini berarti hasil cetak/reproductions.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Unicellular berarti satu sel.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Outer tissue paling dekat artinya shell.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
It merujuk ke membrane yang harus ditembus untuk mencapai cytoplasm.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Pilihan C adalah jawaban terbaik dari opsi yang tersedia karena passage menyebut bahwa setiap sel memiliki nucleus, genetic code, dan RNA. Namun, penjelasan ini harus dibatasi pada konteks passage dan tidak menyatakan secara absolut bahwa sel selalu merupakan unit genetik terkecil dalam biologi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Loosely berarti freely/longgar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Symbiotic berarti mutually dependent.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Ukuran tubuh tergantung jumlah sel, jadi organisme besar punya lebih banyak sel.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Each merujuk ke cells yang specialized.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Sponges dan jellyfish disebut sebagai multicellular paling sederhana.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Tidak ada pembahasan mekanisme reproduksi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Pembahasan utama adalah asal-usul dan sejarah perpustakaan Alexandria.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Feasible berarti practicable.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Karena laporan tersebut bersifat second-hand, informasi tentang library tidak berasal dari bukti langsung sehingga sulit diverifikasi sepenuhnya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Langkah-langkah pengadaan menunjukkan mereka mengalokasikan sumber daya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Tujuan utama: mengumpulkan semua scroll dan memperkaya koleksi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Implikasinya, koleksi tidak dapat diperiksa lagi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Pernyataan ini eksplisit di passage, jadi pilihan C paling tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Akses terbatas menunjukkan manfaat terutama untuk kelas atas/elite.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Not a trace berarti absolutely nothing tersisa.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Seluruh passage fokus pada penentuan usia bumi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Radioactive dating dipakai untuk menentukan umur bumi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Eventual paling dekat dengan ultimate.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Moon rocks seumuran dan bumi-matahari terbentuk hampir bersamaan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Implikasi: asal-usul bumi dan matahari serupa.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Pilihan C adalah jawaban yang paling mendekati karena passage menyebut 'the present rate of expansion of the galaxies', yang menunjukkan bahwa proses kosmik seperti ekspansi galaksi masih berlangsung. Namun, redaksi 'formation of galaxies' kurang presisi dibandingkan 'expansion of galaxies'.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Plausible berarti reasonable.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Penulis menilai radioactive dating lebih akurat dibanding metode lama.\par
\endgroup
\par
\vspace{0.25\baselineskip}
\newpage
