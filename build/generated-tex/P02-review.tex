...
\begin{document}
\section*{TOEFL Practice 02 - Review}
...
Answer: A\par
Confidence: high\par
Grammar rule: Comparative structure with auxiliary do.\par
Dalam perbandingan setelah `more ... than`, bagian kedua perlu auxiliary untuk menggantikan verb `produce`; bentuk yang tepat adalah `than do other branches`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Embedded yes/no clause after a reporting verb.\par
Setelah `No one knows`, dibutuhkan embedded clause yang menyatakan ketidakpastian; `whether` paling tepat untuk memperkenalkan klausa `whether projections ... are reliable`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel past participles after passive verb.\par
Struktur harus paralel dengan `are reached`; karena bagian kedua juga pasif implisit, bentuk yang tepat adalah past participle `surpassed`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Present perfect with since + point in time.\par
Keterangan waktu `Since the 1970s` menuntut present perfect untuk perubahan yang dimulai di masa lalu dan berlanjut sampai sekarang; karena itu `has become increasingly widespread` tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Infinitive of purpose.\par
Setelah `is grated`, diperlukan infinitive of purpose untuk menyatakan fungsi; `to make a spicy food sauce` adalah pola yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Adverbial prepositional phrase of time.\par
Setelah `vision`, frasa waktu yang idiomatis adalah `at night`; pilihan ini menjelaskan kapan ketajaman penglihatan dipertahankan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Plural noun phrase as subject.\par
Karena predikatnya `are`, kalimat memerlukan subjek plural berbentuk noun phrase; `Humorous misunderstandings` paling sesuai secara struktur.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Parallel adverbs modifying a verb.\par
Verb `identify` harus dimodifikasi oleh adverb, dan bentuknya harus paralel dengan `earlier`; jadi `more accurately` adalah pasangan yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: While + gerund for simultaneous action.\par
Setelah `enjoy themselves`, pola yang tepat untuk aksi yang terjadi bersamaan adalah `while learning`; ini bentuk ringkas dari `while they are learning`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective pair before a noun.\par
Kata `style` adalah noun, jadi perlu adjective sebelum noun tersebut; `vigorous and informal style` adalah susunan yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: medium\par
Grammar rule: Fixed time expression with as long as.\par
Soal ini menuntut ungkapan waktu tetap; dari pilihan yang ada, `as long as` adalah bentuk yang paling masuk akal untuk melengkapi ekspresi waktunya.\par
...
Answer: C\par
Confidence: high\par
Grammar rule: Subordinator if + subject + be.\par
Setelah `even`, diperlukan klausa lengkap dengan conjunction dan subject-verb; `if they are not in physical contact` membentuk struktur yang benar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Grammar rule: Parallel noun phrase after led to.\par
Preposisi `to` pada `led to` harus diikuti noun phrase; agar paralel dengan `extravagant living`, bentuk yang benar adalah `a need for a large income`.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective + noun collocation.\par
Setelah `involve`, diperlukan noun phrase yang benar; kolokasi yang tepat adalah `electrical equipment`, bukan bentuk lain yang salah susun.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Grammar rule: Passive infinitive after modal.\par
Setelah modal `could`, diperlukan base form; karena `gunpowder` menerima aksi, bentuk pasif `be used to propel` adalah pola yang tepat.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Grammar rule: Infinitive of purpose after to.\par
Correct form: to reduce\par
Bagian (C) salah karena setelah `to` harus dipakai base verb, bukan noun `reduction`. Bentuk yang benar adalah `to reduce their expenditures`.\par
\endgroup
\par
...
Answer: D\par
Confidence: high\par
Grammar rule: Plural noun after between.\par
Correct form: bodies\par
Bagian (D) salah karena `between` menunjukkan dua pihak atau lebih, sehingga noun harus plural. Bentuk yang benar adalah `between heavenly bodies`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: -ed adjective for people's feelings.\par
Correct form: surprised\par
Bagian (A) salah karena untuk menyatakan perasaan orang digunakan adjective berakhiran `-ed`, bukan `-ing`. Jadi bentuk yang benar adalah `Most people are surprised`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Singular count noun requires an article.\par
Correct form: a person\par
Bagian (C) salah karena `person` adalah singular count noun dan tidak boleh berdiri sendiri tanpa article. Bentuk yang benar adalah `a person`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Adjective needed before noun.\par
Correct form: dead\par
Bagian (D) salah karena setelah `its` dan sebelum `members` dibutuhkan adjective, bukan past verb `died`. Bentuk yang benar adalah `dead members`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Few vs little with count nouns.\par
Correct form: Few\par
Bagian (A) salah karena `animals` adalah countable plural noun, sehingga quantifier yang tepat adalah `few`, bukan `little`. Kalimat yang benar: `Few land animals ...`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: One of the + superlative.\par
Correct form: brightest\par
Bagian (C) salah karena pola `one of the` harus diikuti superlative. Bentuk yang benar adalah `one of the brightest among animals`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: medium\par
Grammar rule: Adjective form before a noun.\par
Correct form: annual\par
Bagian (B) salah karena sebelum noun `events` diperlukan adjective, bukan adverb `annually`. Bentuk yang benar adalah `annual events`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Parallel gerunds/nouns after such tasks as.\par
Correct form: reasoning\par
Bagian (C) salah karena setelah `such tasks as` unsur-unsurnya harus paralel. Karena ada `learning`, bentuk yang sesuai adalah `reasoning`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: As ... as comparison uses base adjective.\par
Correct form: sweet\par
Bagian (D) salah karena pola `as ... as` harus memakai adjective dasar, bukan comparative. Bentuk yang benar adalah `as sweet as sugar`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Correct form: affects\par
Bagian (A) salah karena subjek `Work` bersifat singular dalam kalimat ini, sehingga verb simple present harus singular juga: `affects`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Because + clause; because of + noun phrase.\par
Correct form: Because\par
Bagian (A) salah karena `because of` harus diikuti noun phrase, sedangkan setelahnya ada klausa `attitudes shape behavior`. Bentuk yang benar adalah `Because attitudes shape behavior ...`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Fixed pair: one ... another.\par
Correct form: another\par
Bagian (D) salah karena pasangan bakunya adalah `from one area to another`. `others` tidak cocok setelah `one` dalam pola ini.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Adjective needed before noun.\par
Correct form: dramatic\par
Bagian (B) salah karena noun `fluctuations` harus diterangkan oleh adjective. Bentuk yang benar adalah `dramatic fluctuations`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Linking verb in it is against the law.\par
Correct form: is\par
Bagian (A) salah karena ekspresi yang benar adalah `it is against the law`, bukan `it has against the law`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: D\par
Confidence: high\par
Grammar rule: Reflexive pronoun agreement.\par
Correct form: themselves\par
Bagian (D) salah karena antecedent `people` bersifat plural, sehingga reflexive pronoun juga harus plural: `themselves`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Embedded question word order.\par
Correct form: how\par
Bagian (B) salah karena setelah verb `studied`, embedded question tidak memakai inversi auxiliary-subject. Bentuk yang benar adalah `how society influences the development of science`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Noun form required as subject.\par
Correct form: availability\par
Bagian (A) salah karena subjek kalimat harus berbentuk noun, bukan adjective `available`. Bentuk yang benar adalah `The availability of credit ...`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Present participle compound adjective.\par
Correct form: disease-causing\par
Bagian (C) salah karena yang dimaksud adalah organisme yang menyebabkan penyakit, sehingga modifier aktif yang tepat adalah `disease-causing`, bukan `disease-caused`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Finite verb needed in relative clause.\par
Correct form: wrote\par
Bagian (A) salah karena klausa relatif `who ... books` memerlukan finite verb. Bentuk yang benar adalah `who wrote books about his personal feelings`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Interrogative word choice in embedded clause.\par
Correct form: how\par
Bagian (C) salah karena kalimat membutuhkan kata tanya yang menyatakan cara atau proses pembentukan, bukan `what`. Bentuk yang benar adalah `determine how the solar system was created`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: A\par
Confidence: high\par
Grammar rule: Past participle adjective after be.\par
Correct form: suited\par
Bagian (A) salah karena setelah `are not` diperlukan adjective/past participle, bukan base verb. Bentuk yang benar adalah `are not suited to produce ...`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Grammar rule: Each + singular noun.\par
Correct form: each day\par
Bagian (C) salah karena `each` harus diikuti noun singular. Bentuk yang benar adalah `each day`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: B\par
Confidence: high\par
Grammar rule: Past necessity in historical context.\par
Correct form: had\par
Bagian (B) salah karena konteksnya masa lampau `during the Middle Ages`, sehingga kebutuhan lampau dinyatakan dengan `had to`, bukan `has to`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Confidence: high\par
Grammar rule: Infinitive of purpose after to.\par
Correct form: prevent\par
Bagian (C) salah karena setelah `to` harus digunakan base verb, bukan `-ing` form. Bentuk yang benar adalah `to prevent them from spoiling`.\par
\endgroup
\par
\vspace{\questionblockgap}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 1-16\par
Evidence quote: "The Globe Theater, where most of Shakespeare's plays were staged and performed..."\par
Jawaban (C) karena seluruh passage membahas asal-usul, desain, kapasitas, kebakaran, dan pembongkaran Globe Theater, jadi paling cocok sebagai bagian dari sejarah teater Inggris.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "built the theater in 1599 with materials left over from the construction of London's first playhouse"\par
Jawaban (B) karena passage secara eksplisit menyebut teater itu dibangun dari sisa material proyek lain.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "counted on making the theater a draw for the locals"\par
Jawaban (B) karena dalam konteks ini a draw berarti sesuatu yang menarik orang datang, yaitu an attraction.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Little is known about the architectural design... except what can be deduced"\par
Jawaban (C) karena penulis menekankan bahwa detail desain hanya bisa disimpulkan, bukan diketahui secara pasti.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "In keeping with the contemporary imitations of Roman government buildings"\par
Jawaban (D) karena imitations di sini berarti peniruan atau emulation terhadap bangunan Romawi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The size of its audience is projected at as many as 3,000 spectators"\par
Jawaban (A) karena projected dalam konteks jumlah berarti diperkirakan atau calculated.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 11-12\par
Evidence quote: "as many as 3,000 spectators both in the amphitheater and in the balcony"\par
Jawaban (D) karena kapasitas sampai 3.000 penonton menunjukkan Globe tergolong besar untuk zamannya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The Globe burned down in 1613; it was rebuilt... a year later"\par
Jawaban (B) karena ada bangunan asli lalu bangunan pengganti setelah kebakaran, jadi total dua bangunan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "built hastily... safety was not a top priority... several nearly fatal accidents"\par
Jawaban (C) karena deskripsi soal pembangunan tergesa-gesa dan kecelakaan nyaris fatal menunjukkan bangunan terakhir itu berbahaya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 14-16\par
Evidence quote: "The theater was built hastily, and evidently safety was not a top priority"\par
Jawaban (B) karena penulis memberi kesan bahwa para pembangun tidak merancangnya dengan pertimbangan matang, setidaknya dalam aspek keselamatan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "organic compounds that regulate the mechanisms by which the body converts food into energy"\par
Jawaban (A) karena regulate di sini berarti mengatur atau control proses tubuh.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 1-2\par
Evidence quote: "Vitamins, taken in tiny doses, are a major group of organic compounds"\par
Jawaban (B) karena passage menjelaskan vitamin sebagai senyawa penting yang membantu tubuh memproses energi, yaitu essential nutrients.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the naming of vitamins... the nomenclature of individual substances"\par
Jawaban (B) karena nomenclature merujuk pada sistem penamaan atau pengelompokan, paling dekat dengan classification.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 5-7\par
Evidence quote: "Among the 13 vitamins known today, five are produced in the body"\par
Jawaban (C) karena jika total 13 dan 5 diproduksi tubuh, maka 8 harus diperoleh dari makanan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the body produces sufficient quantities of some but not all vitamins"\par
Jawaban (A) karena implikasinya makanan harus menyediakan vitamin yang tidak diproduksi tubuh, jadi makanan menyuplai sebagian, bukan semua, vitamin yang diperlukan tubuh secara keseluruhan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "they must be supplemented in the daily diet"\par
Jawaban (C) karena daily diet dalam konteks ini berarti asupan makanan sehari-hari atau nourishment intake.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "When a lack of even one vitamin in a diet is continual, a vitamin deficiency may result"\par
Jawaban (D) karena kekurangan vitamin terus-menerus dapat menyebabkan deficiency, jadi jelas berbahaya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 11-15\par
Evidence quote: "maintain a balanced diet that includes a variety of foods and provides adequate quantities"\par
Jawaban (B) karena penulis menyatakan cara terbaik adalah diet seimbang yang bervariasi, yang berarti diet seperti itu dapat menyediakan semua vitamin yang diperlukan.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 15-18\par
Evidence quote: "recommended only... or to act as a therapeutic measure in medical treatment"\par
Jawaban (A) karena passage secara langsung menyebut penggunaan suplemen sebagai langkah terapeutik dalam kasus medis tertentu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "to act as a therapeutic measure in medical treatment"\par
Jawaban (A) karena act as berarti berfungsi sebagai atau play the role of.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "fat-soluble substances, such as vitamins A and D"\par
Jawaban (A) karena jika penulis menyebut beberapa vitamin sebagai fat-soluble, implikasinya ada vitamin lain yang tidak demikian.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 1-20\par
Evidence quote: "Vitamins... regulate... best way... balanced diet... supplements"\par
Jawaban (D) karena passage membahas peran vitamin dalam tubuh, sumbernya dari diet, dan kapan suplemen diperlukan, jadi fokusnya adalah tempat vitamin dalam nutrisi.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 1-19\par
Evidence quote: "jazz began to lose its reputation... gain acclaim... musicians began to feature many instruments"\par
Jawaban (D) karena passage menyoroti naiknya prestise jazz sekaligus makin beragamnya bentuk, instrumen, dan gayanya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 2-3\par
Evidence quote: "musicians began to feature many instruments previously considered inappropriate"\par
Jawaban (D) karena feature di sini berarti menonjolkan atau mempromosikan penggunaan instrumen tertentu.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Whereas before the 1950s, jazz musicians played only eight basic instruments"\par
Jawaban (C) karena kalimat pembuka membandingkan periode sebelum 1950-an, jadi paragraf sebelumnya paling mungkin membahas jazz pada 1940-an.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "in this decade they started to improvise on the flute, electric organ... and even bagpipes"\par
Jawaban (C) karena penulis menunjukkan adanya eksperimen baru dalam instrumen dan pengaturan ritme.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: D\par
Confidence: high\par
Evidence refs: lines 4-9\par
Evidence quote: "flute, electric organ, piccolo, accordion, cello, and even bagpipes... drums and a string bass"\par
Jawaban (D) karena harpsichord tidak pernah disebut, sedangkan bagpipes, drums/percussion, dan string bass disebut.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "most changes emerged from small combos"\par
Jawaban (C) karena passage mengaitkan perubahan-perubahan penting justru dengan small combos, jadi mereka bersifat inovatif.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: B\par
Confidence: high\par
Evidence refs: lines 10-17\par
Evidence quote: "Jazz continued to move in new directions... blended jazz and rock music into fusion jazz"\par
Jawaban (B) karena nada passage menunjukkan perkembangan ini penting dan berdampak pada bentuk jazz berikutnya.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 10-17\par
Evidence quote: "free jazz... experiments... included melodies from India... fusion jazz"\par
Jawaban (D) karena musisi yang dibahas terus mencari teknik dan isi baru, baik dalam bentuk maupun materi musikal.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "musicians blended jazz and rock music into fusion jazz"\par
Jawaban (B) karena perubahan pada 1970-an dijelaskan berasal dari penggabungan jazz dengan rock, yaitu tren musik lain.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the younger musicians of the time felt compelled to include a steady, swinging rhythm"\par
Jawaban (A) karena compelled paling dekat dengan forced dalam konteks merasa terdorong kuat; namun nuansanya juga dekat dengan obligated.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: A\par
Confidence: high\par
Evidence refs: lines 3-19\par
Evidence quote: "before the 1950s... in this decade... during the 1960s... In the 1970s"\par
Jawaban (A) karena passage disusun menurut urutan waktu untuk menunjukkan inovasi jazz dari 1950-an sampai 1970-an.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: line 1\par
Evidence quote: "The killdeer is a commonly found shore bird"\par
Jawaban (C) karena shore bird menunjukkan habitat khas wilayah pesisir atau dekat perairan pantai.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 2-3\par
Evidence quote: "barbs and barbules impart a sleek appearance to its body"\par
Jawaban (A) karena impart di sini berarti memberikan tampilan tertentu pada tubuh burung.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 4-5\par
Evidence quote: "The male's loud shrill, which seems to say kill-deer"\par
Jawaban (B) karena nama burung dijelaskan berasal dari bunyi suaranya yang khas.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "not structured to make melodious notes"\par
Jawaban (B) karena melodious berarti bernada merdu atau musical.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Camouflaged by their protective grayish brown pigment"\par
Jawaban (B) karena warna kamuflase membuat killdeer tidak mudah terlihat, yaitu inconspicuous.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the mother tries to distract the intruder by dragging one of her wings as if it were injured"\par
Jawaban (A) karena induk berpura-pura terluka, jadi seolah-olah rentan untuk mengalihkan perhatian predator.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "Farmers are particularly fond of killdeers because they feed on insects that damage crops"\par
Jawaban (B) karena petani menyukai manfaat killdeer yang memakan serangga perusak tanaman.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Answer: C\par
Confidence: high\par
Evidence refs: lines 1-15\par
Evidence quote: "The killdeer is a commonly found shore bird... game laws have been enacted to protect these plovers"\par
Jawaban (C) karena nada penulis informatif dan faktual; tidak terasa mengancam, lucu, atau sangat personal.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The kite's ability to fly depends on its construction and the way that its line is attached"\par
Jawaban (D) karena inti passage terutama menjelaskan mekanisme yang membuat layang-layang tetap terbang.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 1-2\par
Evidence quote: "Benjamin Franklin made his textbook experiment"\par
Jawaban (C) karena textbook di sini berarti classic atau sangat khas/terkenal sebagai contoh standar.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "These two seemingly unrelated events"\par
Jawaban (A) karena seemingly berarti tampaknya atau ostensibly.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 6-7\par
Evidence quote: "lift men and carry cameras aloft"\par
Jawaban (A) karena aloft dalam konteks ini berarti berada di udara, yaitu in flight.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 9-10\par
Evidence quote: "The line attached to the nose of the kite pulls it into the wind"\par
Jawaban (B) karena passage menyebut hidung layang-layang harus ditarik menghadap angin.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: high\par
Evidence refs: lines 11-13\par
Evidence quote: "greater pressure against its face and lower pressure against its back"\par
Jawaban (C) karena perbedaan tekanan itulah yang menciptakan lift agar layang-layang naik.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "The towing point to which the line is attached is important because it sets the kite's angle relative to the air flow"\par
Jawaban (C) karena fungsi penting tali adalah menentukan sudut antara layang-layang dan aliran udara.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Evidence quote: "the kite must be headed up and into the wind"\par
Jawaban (C) karena headed up berarti diarahkan ke atas/ke arah tertentu, paling dekat dengan directed.\par
\endgroup
\par
\vspace{0.25\baselineskip}
...
Confidence: medium\par
Evidence refs: lines 8-18\par
Evidence quote: "The familiar diamond-shaped kite flies... maintain its position through a tail, a rudder, a keel, vents, or tassels"\par
Jawaban (C) paling mungkin karena paragraf ini sudah membahas cara kerja layang-layang diamond-shaped; lanjutan yang logis adalah tipe desain lain, misalnya bowed kites. Namun item ini tetap cukup inferensial.\par
Needs manual review: true\par
\endgroup
\par
\vspace{0.25\baselineskip}
